 ...
 */
class exam extends \ExamsBundle\Entity\exam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ExamsBundle\\Entity\\exam' . "\0" . 'idE', '' . "\0" . 'ExamsBundle\\Entity\\exam' . "\0" . 'subject', '' . "\0" . 'ExamsBundle\\Entity\\exam' . "\0" . 'session', '' . "\0" . 'ExamsBundle\\Entity\\exam' . "\0" . 'duration'];
        }
