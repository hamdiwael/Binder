 ...
 */
class abscense extends \BinBundle\Entity\abscense implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BinBundle\\Entity\\abscense' . "\0" . 'id', '' . "\0" . 'BinBundle\\Entity\\abscense' . "\0" . 'pupl', '' . "\0" . 'BinBundle\\Entity\\abscense' . "\0" . 'nbr', '' . "\0" . 'BinBundle\\Entity\\abscense' . "\0" . 'date', '' . "\0" . 'BinBundle\\Entity\\abscense' . "\0" . 'subject', '' . "\0" . 'BinBundle\\Entity\\abscense' . "\0" . 'notification'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (abscense $proxy) {
    ...
    public function setPupl($pupl)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPupl', [$pupl]);

        return parent::setPupl($pupl);
    }
    ...
    public function getPupl()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPupl', []);

        return parent::getPupl();
    }
