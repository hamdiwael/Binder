...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\ExamsBundle\\Entity')]), 'ExamsBundle\\Entity');

$a->setEntityNamespaces(['ExamsBundle' => 'ExamsBundle\\Entity']);
