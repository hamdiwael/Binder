...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/CourseBundle/Entity'), 2 => ($this->targetDirs[3].'/src/ExamsBundle/Entity'), 3 => ($this->targetDirs[3].'/src/BinBundle/Entity'), 4 => ($this->targetDirs[3].'/src/classBundle/Entity'), 5 => ($this->targetDirs[3].'/src/ClubBundle/Entity')]);

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'CourseBundle\\Entity');
$b->addDriver($c, 'ExamsBundle\\Entity');
$b->addDriver($c, 'BinBundle\\Entity');
$b->addDriver($c, 'classBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'CourseBundle' => 'CourseBundle\\Entity', 'ExamsBundle' => 'ExamsBundle\\Entity', 'BinBundle' => 'BinBundle\\Entity', 'classBundle' => 'classBundle\\Entity', 'ClubBundle' => 'ClubBundle\\Entity']);
