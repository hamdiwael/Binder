...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            // create-course
            if ('/admin/create-course' === $pathinfo) {
            ...
            // update-course
            if (0 === strpos($pathinfo, '/admin/update-course') && preg_match('#^/admin/update\\-course/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
            ...
            // delete-course
            if (0 === strpos($pathinfo, '/admin/delete-course') && preg_match('#^/admin/delete\\-course/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
