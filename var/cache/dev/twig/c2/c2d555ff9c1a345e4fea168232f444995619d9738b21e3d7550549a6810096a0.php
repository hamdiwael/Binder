...
class __TwigTemplate_38007779c16e80d3221979fa1f5fd0308845c22cb7c9c3291b84c5a7f41adab7 extends \Twig\Template
{
    ...
    <div class=\"jumbotron jumbotron-fluid\">
        <div class=\"container\">
            <h1 class=\"display-4\">";
        // line 8
        echo twig_escape_filter($this->env, $this->getAttribute(($context["notification"] ?? $this->getContext($context, "notification")), "category", []), "html", null, true);
        echo "</h1>
            ";
        // line 10
        echo "            <h3 class=\"lead\"> ";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["notification"] ?? $this->getContext($context, "notification")), "receiver", []), "html", null, true);
        echo " </h3>
            <h3 class=\"lead\"> ";
        // line 11
        echo twig_escape_filter($this->env, $this->getAttribute(($context["notification"] ?? $this->getContext($context, "notification")), "content", []), "html", null, true);
        echo " </h3>
            <a style=\" background-color: #8B0000;color: white;\" class=\"btn btn-success\" href=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("replynot", ["id" => $this->getAttribute(($context["notification"] ?? $this->getContext($context, "notification")), "id", [])]), "html", null, true);
        echo "\">Reply</a></td>
            <a href=\"";
        // line 13
...
{% endblock %}", "@Bin/notification/show.html.twig", "/home/wael/34/final/Binder/src/BinBundle/Resources/views/notification/show.html.twig");
    }
}
