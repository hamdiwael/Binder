...
class __TwigTemplate_2b1f3928c8861a0b69a90cd6b529c1dbffab470f669a42e730ef0c65cd87b643 extends \Twig\Template
{
...
<div class=\"form-group\">
    ...
    ";
        ...
        echo "  </div></div> </div></div> </section></div> </section> </section>
</body>
...
";
    ...
    {
        return array (  97 => 25,  93 => 24,  89 => 23,  85 => 22,  80 => 20,  75 => 18,  60 => 5,  51 => 4,  29 => 2,);
    }
...
<h1>Add an exam</h1>
    ...
    {{ form_start(form) }}
<div class=\"form-group\">
    subject:* {{ form_widget(form.subject) }} </br>

    Date:* {{ form_widget(form.date) }}</br>
    duration:* {{ form_widget(form.duration) }}</br> <br/>
    {{ form_widget(form.confirm) }}</br>
    {{ form_end(form) }}  </div></div> </div></div> </section></div> </section> </section>
</body>
