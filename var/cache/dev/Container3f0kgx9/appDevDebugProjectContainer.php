...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-5x9bkLLyw', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A04vrU2ING', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('orMrQSH5vz', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tf084iO8Lb', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hrFenMXqSj', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), '!FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/CourseBundle/Resources/views'), 'Course');
        $instance->addPath(($this->targetDirs[3].'/src/CourseBundle/Resources/views'), '!Course');
        $instance->addPath(($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/views'), 'KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/views'), '!KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'/src/ExamsBundle/Resources/views'), 'Exams');
        $instance->addPath(($this->targetDirs[3].'/src/ExamsBundle/Resources/views'), '!Exams');
        $instance->addPath(($this->targetDirs[3].'/src/BinBundle/Resources/views'), 'Bin');
        $instance->addPath(($this->targetDirs[3].'/src/BinBundle/Resources/views'), '!Bin');
        $instance->addPath(($this->targetDirs[3].'/src/classBundle/Resources/views'), 'class');
        $instance->addPath(($this->targetDirs[3].'/src/classBundle/Resources/views'), '!class');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'CourseBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CourseBundle'),
                ...
                'ExamsBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ExamsBundle'),
                    'namespace' => 'ExamsBundle',
                ],
                'BinBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/BinBundle'),
                    'namespace' => 'BinBundle',
                ],
                'classBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/classBundle'),
            ...
            case 'brochures_directory': $value = ($this->targetDirs[3].'/app/../web/uploads/brochures'); break;
            ...
            case 'knp_snappy.pdf.binary': $value = ($this->targetDirs[5].'/Binder/vendor/bin/wkhtmltopdf-amd64'); break;
            case 'knp_snappy.image.binary': $value = ($this->targetDirs[5].'/Binder/vendor/bin/wkhtmltoimage-amd64'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'CourseBundle' => 'CourseBundle\\CourseBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'ExamsBundle' => 'ExamsBundle\\ExamsBundle',
                'BinBundle' => 'BinBundle\\BinBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'binder2',
            'database_user' => 'root',
            'database_password' => 'P@ssw0rd',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'wael.hamdi.m8@gmail.com',
            'mailer_password' => 'P@ssw0rd',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'wael.hamdi.m8@gmail.com',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'wael.hamdi1@esprit.tn' => 'waelhamdi',
            ],
