...
class abscenseController extends Controller
{
            ...
            public function showAction( $id)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $abscnese = $em->getRepository('BinBundle:abscense')->find($id);
        return $this->render('@Bin/abscense/show.html.twig', array(
        'abscense' => $abscnese
    ));
    }
    ...
    public function listFrontAction(Request $request)
    {
        ...
        if(!$request->query->has('filter'))
        {
            return $this->render('@Bin/abscense/listFront.html.twig',array(
                'abscense'=>$abscense
            ));
        }else{
            $abscenseFilter = $em->getRepository("BinBundle:abscense")
    ...
    public function calendarAction($id)
    {
        ...
        /*return $this->render('@Bin/abscense/calendar.html.twig', array(
            'abscense' => $abscense
        ));*/
        $json = array();
